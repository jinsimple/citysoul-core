<?php
/*
Plugin Name: Citysoul postype and function
Plugin URI: http://beautheme.com
Description: This plugin create all postype and function of Citysoul theme.
Version: 1.0.3
Author: BeauTheme
	...
	class beau_ThemePlugin {
        ...
        public function beau_getThirdpary(){
            ...
            foreach ($plugins as $key => $plugin) {
                if (strlen($plugin) > 3 && $plugin !='.DS_Store' && $plugin !='index.html') {
