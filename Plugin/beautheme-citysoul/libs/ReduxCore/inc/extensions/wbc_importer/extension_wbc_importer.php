    ...
    class ReduxFramework_extension_wbc_importer {
        ...
        public function __construct( $parent ) {
            ...
            if ( empty( $this->extension_dir ) ) {
                ...
                $setfile = str_replace('/libs/ReduxCore/inc/extensions/','',$file);
                $this->demo_data_dir = apply_filters( "wbc_importer_dir_path", $setfile.'/demo-data/' );
            }
        ...
        function add_importer_section() {
			...
			if(empty($errors)){
				...
				foreach($errors as $error) {
					$warning_text .= "<p class = 'notice notice-warning'>".$error."</p>";
				}
			}
